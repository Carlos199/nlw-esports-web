...
<div>
<strong className='text-2xl text-white font-black block'>No encontro su duo?</strong>
<span className='text-zinc-400 block'>Publique un anuncio para encontrar nuevos players</span>
</div>
